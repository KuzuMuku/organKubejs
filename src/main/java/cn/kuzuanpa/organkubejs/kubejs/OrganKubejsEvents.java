...
public final class OrganKubejsEvents {
    ...
    public static final EventHandler PREDICATE = GROUP.server("predicate", () -> PredicateEventJS.class).hasResult();
    public static final EventHandler POINT_ACTION = GROUP.server("pointAction", () -> PointActionEventJS.class).hasResult();
